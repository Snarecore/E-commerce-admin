...
const VendorSubscriptionTable = ({
    ...
    const apiUrl = apiConfig.subscription.vendorSubscriptionUrl;
                        ...
                        {dataList?.length > 0 ? (
                            dataList?.map((data, index) => (
                                ...
                                >
                                    ...
                                    <td className="px-6 py-4">
                                        {data.tier.durationInMonths} month
                                    </td>
                                    <td className="px-6 py-4">
                                        <div className="flex items-center gap-2">
                                            <button
                                                onClick={() => navigate(`/vendor-invoice/${data.id}`)}

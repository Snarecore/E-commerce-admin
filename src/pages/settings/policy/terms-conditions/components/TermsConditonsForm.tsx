...
import { termsConditionsCmsQueryKey } from "../../../../../config/query-key";
...
const TermsConditionsForm = () => {
    ...
    const apiUrl = apiConfig.setting.policy.termsConditionsUrl;
    ...
    const handleSubmitForm = async () => {
        ...
        const result = await handleApiMutation({
            ...
            url,
            body: fieldValues,
            invalidateQueryKey: [termsConditionsCmsQueryKey],
        ...
        if (result?.success) {
            fetchTermsConditionsCmsData();
        }
    };

    const [isLoading, setIsLoading] = useState<boolean>(true);
    const fetchTermsConditionsCmsData = async () => {
        setIsLoading(true);
        try {

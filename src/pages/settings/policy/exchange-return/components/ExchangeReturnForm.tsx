...
import { exchangeReturnCmsQueryKey } from "../../../../../config/query-key";
...
const ExchangeReturnForm = () => {
    ...
    const apiUrl = apiConfig.setting.policy.exchangeReturnUrl;
    ...
    const handleSubmitForm = async () => {
        ...
        const result = await handleApiMutation({
            ...
            url,
            body: fieldValues,
            invalidateQueryKey: [exchangeReturnCmsQueryKey],

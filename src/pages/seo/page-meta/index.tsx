...
import PageMetaTable from "./component/PageMetaTable";
import PageMetaForm from "./component/PageMetaForm";
...
const PageMeta = () => {
    ...
    const getMetaDataApiUrl = () => {
		const apiUrl = `${apiConfig.pageMeta.pageMetaUrl}?page=${currentPageNumber}&limit=${dataLimit}`;
		return apiUrl;
	}
    ...
    return (
        <>
            ...
            {/* @ts-ignore */}
            <PageMetaForm isOpen={isModalOpen} onClose={closeModal} fetchData={fetchData} editData={editData} />
        </>
    );
};

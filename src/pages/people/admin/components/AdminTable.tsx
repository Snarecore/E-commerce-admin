...
const AdminTable = ({
    ...
    const handleDelete = async () => {
        ...
        const apiResponse = await handleDeleteAPI({
            url: `${apiUrl}/${selectedAdminList.id}`,
                                    ...
                                    <td className="px-6 py-4">
                                        <div className="flex items-center gap-2">
                                            <button
                                                ...
                                                className={`border border-gray-300 text-gray-700 hover:text-[var(--color-primary)] hover:bg-gray-200 cursor-pointer p-2 rounded-md transition duration-300 ${user.id === data.id ? 'opacity-50 cursor-not-allowed' : ''}`}

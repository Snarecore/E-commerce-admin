...
const VendorPayoutModal: React.FC<ModalProps> = ({ isOpen, title, onClose, children, footerButtons }) => {
	...
	return (
		<div className="fixed inset-0 flex items-center justify-center bg-opacity-50 bg-[#000000b6] z-50 top-0 right-0 left-0 bottom-0 p-2">
			<div className="bg-white rounded-lg shadow-lg w-[600px] p-6 flex flex-col">
